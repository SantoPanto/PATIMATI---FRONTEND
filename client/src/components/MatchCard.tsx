  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 border-b border-slate-100 px-5 py-3 text-xs font-semibold">
        <div className="flex items-center gap-1.5">
          {hasBlock ? (
            ...
            <span className="inline-flex items-center gap-1 rounded-full bg-emerald-100 px-2.5 py-1 text-emerald-800 font-bold">
      ...
      <div className="p-5">
        ...
        {hasBlock && (
          <div className="mt-4 flex items-start gap-2.5 rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-xs font-medium text-rose-700" role="alert">
        ...
        <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-3">
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-600 transition hover:text-orange-600 focus:outline-none"
          >
        ...
        {/* Breakdown Section */}
        {showDetails && (
          <div className="mt-4 space-y-3 rounded-2xl border border-slate-100 bg-slate-50/80 p-4 text-xs">
            <h4 className="font-bold text-slate-700 mb-2">Eşleşme Kırılım Analizi</h4>
