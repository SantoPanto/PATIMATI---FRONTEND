  ...
  return (
    ...
    >
      <section
        ...
        aria-modal="true"
        className="max-h-full w-full max-w-lg overflow-y-auto rounded-[28px] border border-slate-100 bg-white shadow-2xl shadow-slate-950/25"
        role="dialog"
        ...
        {basarili ? (
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2">
              ...
              <span className="text-sm text-slate-400">ya da il/ilçe yaz:</span>
            </div>
            ...
            <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-[1fr_1fr_auto]">
              ...
              <div className="col-span-2 flex items-end sm:col-span-1">
                <button
                  ...
                  className="rounded-xl border border-slate-300 px-4 py-2 text-sm font-medium text-slate-600 transition hover:border-emerald-500 hover:text-emerald-600"
                >
                  Bul
                </button>
              </div>
