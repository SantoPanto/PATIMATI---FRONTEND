...
export default function AiMatchPage() {
  ...
  const handleStartMatching = async () => {
    ...
    try {
      ...
      const result = await request<MatchedAdResponseDTO[]>("/api/ai-match", { method: "POST", body: formData, requiresAuth: true }); sessionStorage.setItem("aiMatchResults", JSON.stringify(result)); navigate("/ai-match-results");
    } catch (error) {
