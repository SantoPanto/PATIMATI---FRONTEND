...
import { analyzeImage, extractFeaturesFromAiAnalysis, matchImage } from "../services/ai";
  ...
  const runAiAnalysis = async () => {
    ...
    try {
      ...
      if (analysis.is_pet === false) {
        ...
        if (extracted.collarStatus) {
          updateForm("collarStatus", extracted.collarStatus);
        }
